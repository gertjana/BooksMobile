...
// in simulator we redefine to format for BooksMobile Developer console
...
{\
	NSString * exceptionName = [@"org.booksmobile." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.booksmobile";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIBooksMobileNativeItemNone = -1, 
	UIBooksMobileNativeItemSpinner = -2,
	UIBooksMobileNativeItemProgressBar = -3,
	
	UIBooksMobileNativeItemSlider = -4,
	UIBooksMobileNativeItemSwitch = -5,
	UIBooksMobileNativeItemMultiButton = -6,
	UIBooksMobileNativeItemSegmented = -7,
	
	UIBooksMobileNativeItemTextView = -8,
	UIBooksMobileNativeItemTextField = -9,
	UIBooksMobileNativeItemSearchBar = -10,
	
	UIBooksMobileNativeItemPicker = -11,
	UIBooksMobileNativeItemDatePicker = -12,
	
	UIBooksMobileNativeItemInfoLight = -13,
	UIBooksMobileNativeItemInfoDark = -14,
	
	UIBooksMobileNativeItemDisclosure = -15,
	
	UIBooksMobileNativeItemContactAdd = -16
};
